  ...
  return (
    <footer className='footer'>
      <div className='footer-wrapper'>
        ...
        <p className='footer-message'>
          Essa é uma aplicação open-source e sob a <a className='footer-link' href='https://pt.wikipedia.org/wiki/Licen%C3%A7a_MIT' target='_blank'>licença MIT</a>. Todo o código pode ser encontrado no <a className='footer-link' href='https://github.com/danilowoz/eleicoesvaledoitapocu' target='_blank'>Github</a>.
        </p>
        <p className='footer-message'>
